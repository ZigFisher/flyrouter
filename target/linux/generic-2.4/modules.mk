...
$(eval $(call KMOD_template,PPP,ppp,\
	...
	$(MODULES_DIR)/kernel/drivers/net/ppp_synctty.o \
,CONFIG_PPP,,55,slhc ppp_generic ppp_async pppox ppp_synctty))

$(eval $(call KMOD_template,MPPE,mppe,\
	$(MODULES_DIR)/kernel/drivers/net/ppp_mppe_mppc.o \
	$(MODULES_DIR)/kernel/crypto/arc4.o \
	$(MODULES_DIR)/kernel/crypto/sha1.o \
	$(MODULES_DIR)/kernel/crypto/deflate.o \
,CONFIG_PPP_MPPE_MPPC,,56,arc4 sha1 deflate ppp_mppe_mppc))
...
,CONFIG_USB_ACM,kmod-usb-acm,61,acm))
...
$(eval $(call KMOD_template,USB_SIERRA,usb-sierra,\
	$(MODULES_DIR)/kernel/drivers/usb/serial/sierra.o \
,CONFIG_USB_SIERRA,kmod-usb-sierra,61,sierra))
...
$(eval $(call KMOD_template,USB_SERIAL_CP210X,usb-serial-cp210x,\
	$(MODULES_DIR)/kernel/drivers/usb/serial/cp210x.o \
,CONFIG_USB_SERIAL_CP210X,kmod-usb-serial,61,cp210x))
...
,CONFIG_BLUEZ,,57,bluez l2cap hci_usb rfcomm hci_uart crc32 bnep))
